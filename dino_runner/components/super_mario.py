...
from dino_runner.utils.constants import DEFAULT_TYPE, IMG_JUMPING_SHIELD, IMG_RUNNING_SHIELD, JUMPING_SHIELD, RUNNING_SHIELD
from dino_runner.utils.constants_mario import DRIVING, DRIVING_SHIELD, DRIVING_YOSHI, IMG_DRIVING, IMG_DRIVING_GIGANT, IMG_DRIVING_SHIELD, IMG_DRIVING_YOSHI, IMG_JUMPING, IMG_JUMPING_YOSHI, JUMPING, JUMPING_YOSHI, MARIO_ANGEL, IMG_RUNNING, IMG_RUNNING_YOSHI, RUNNING, RUNNING_YOSHI, SHIELD_TYPE, YOSHI_TYPE
